...
const defaults$2 = forwardRef(() => OptionsProvider.defaults.dropdown);
...
const MouseEvent = ((global)).MouseEvent;
// mocking navigator
...
// angular universal hacks
/* tslint:disable-next-line */
const DragEvent = ((global)).DragEvent;
const CUSTOM_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => TagInputComponent),
    multi: true
};
const defaults$1 = forwardRef(() => OptionsProvider.defaults.tagInput);
class TagInputComponent extends TagInputAccessor {
    ...
    constructor(renderer, dragProvider) {
         ...
         */
        this.separatorKeys = new defaults$1().separatorKeys;
        /**
         * \@name separatorKeyCodes
         * @desc keyboard key codes with which a user can separate items
         */
        this.separatorKeyCodes = new defaults$1().separatorKeyCodes;
        /**
         * \@name placeholder
         * @desc the placeholder of the input text
         */
        this.placeholder = new defaults$1().placeholder;
        /**
         * \@name secondaryPlaceholder
         * @desc placeholder to appear when the input is empty
         */
        this.secondaryPlaceholder = new defaults$1().secondaryPlaceholder;
        /**
         * \@name maxItems
         * @desc maximum number of items that can be added
         */
        this.maxItems = new defaults$1().maxItems;
        /**
         * \@name validators
         * @desc array of Validators that are used to validate the tag before it gets appended to the list
         */
        this.validators = new defaults$1().validators;
        /**
         * \@name asyncValidators
         * @desc array of AsyncValidator that are used to validate the tag before it gets appended to the list
         */
        this.asyncValidators = new defaults$1().asyncValidators;
        /**
         * - if set to true, it will only possible to add items from the autocomplete
         * \@name onlyFromAutocomplete
         */
        this.onlyFromAutocomplete = new defaults$1().onlyFromAutocomplete;
        /**
         * \@name errorMessages
         */
        this.errorMessages = new defaults$1().errorMessages;
        /**
         * \@name theme
         */
        this.theme = new defaults$1().theme;
        /**
         * \@name onTextChangeDebounce
         */
        this.onTextChangeDebounce = new defaults$1().onTextChangeDebounce;
        /**
         * - custom id assigned to the input
         * \@name id
         */
        this.inputId = new defaults$1().inputId;
        /**
         * - custom class assigned to the input
         */
        this.inputClass = new defaults$1().inputClass;
        /**
         * - option to clear text input when the form is blurred
         * \@name clearOnBlur
         */
        this.clearOnBlur = new defaults$1().clearOnBlur;
        /**
         * - hideForm
         * \@name clearOnBlur
         */
        this.hideForm = new defaults$1().hideForm;
        /**
         * \@name addOnBlur
         */
        this.addOnBlur = new defaults$1().addOnBlur;
        /**
         * \@name addOnPaste
         */
        this.addOnPaste = new defaults$1().addOnPaste;
        /**
         * - pattern used with the native method split() to separate patterns in the string pasted
         * \@name pasteSplitPattern
         */
        this.pasteSplitPattern = new defaults$1().pasteSplitPattern;
        /**
         * \@name blinkIfDupe
         */
        this.blinkIfDupe = new defaults$1().blinkIfDupe;
        /**
         * \@name removable
         */
        this.removable = new defaults$1().removable;
        /**
         * \@name editable
         */
        this.editable = new defaults$1().editable;
        /**
         * \@name allowDupes
         */
        this.allowDupes = new defaults$1().allowDupes;
        /**
         * \@description if set to true, the newly added tags will be added as strings, and not objects
         * \@name modelAsStrings
         */
        this.modelAsStrings = new defaults$1().modelAsStrings;
        /**
         * \@name trimTags
         */
        this.trimTags = new defaults$1().trimTags;
        /**
         * \@name ripple
         */
        this.ripple = new defaults$1().ripple;
        /**
         * \@name tabindex
         * @desc pass through the specified tabindex to the input
         */
        this.tabindex = new defaults$1().tabIndex;
        /**
         * \@name disable
         */
        this.disable = new defaults$1().disable;
        /**
         * \@name dragZone
         */
        this.dragZone = new defaults$1().dragZone;
        /**
         * \@name onRemoving
         */
        this.onRemoving = new defaults$1().onRemoving;
        /**
         * \@name onAdding
         */
        this.onAdding = new defaults$1().onAdding;
        /**
         * \@name animationDuration
         */
        this.animationDuration = new defaults$1().animationDuration;
        /**
         * \@name onAdd
    ...
    onRemoveRequested(tag, index) {
        const /** @type {?} */ subscribeFn = (model) => this.removeItem(model, index);
        this.onRemoving ?
            this.onRemoving(tag)
                .first()
    ...
    onDragStarted(event, tag, index) {
        event.stopPropagation();
        const /** @type {?} */ item = ({ zone: this.dragZone, tag, index });
    ...
    setUpTextChangeSubscriber() {
        this.inputForm.form
            ...
            .map(() => this.formValue)
            .subscribe((value) => this.onTextChange.emit(value));
    }
    /**
