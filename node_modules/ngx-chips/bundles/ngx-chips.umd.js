(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('ng2-material-dropdown'), require('rxjs/Observable'), require('rxjs/add/observable/of'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/map'), require('rxjs/add/operator/first'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'ng2-material-dropdown', 'rxjs/Observable', 'rxjs/add/observable/of', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/filter', 'rxjs/add/operator/map', 'rxjs/add/operator/first', '@angular/animations'], factory) :
	(factory((global['ngx-chips'] = {}),global.ng.core,global.ng.forms,global.ng.common,global['ng2-material-dropdown'],global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.animations));
}(this, (function (exports,core,forms,common,ng2MaterialDropdown,Observable,of,debounceTime,filter,map,first,animations) { 'use strict';
...
TagRipple.decorators = [
    { type: core.Component, args: [{
                ...
                animations: [
                    core.trigger('ink', [
                        core.state('none', core.style({ width: 0, opacity: 0 })),
                        core.transition('none => clicked', [
                            core.animate(300, core.keyframes([
                                core.style({ opacity: 1, offset: 0, width: '30%', borderRadius: '100%' }),
                                core.style({ opacity: 1, offset: 0.5, width: '50%' }),
                                core.style({ opacity: 0.5, offset: 1, width: '100%', borderRadius: '16px' })
                            ]))
                        ])
                    ])
                ]
...
var TagComponent = (function () {
    ...
    TagComponent.prototype.storeNewValue = function (input) {
        ...
        var /** @type {?} */ model = typeof this.model === 'string' ? input : (_a = {}, _a[this.identifyBy] = hasId() ? this.model[this.identifyBy] : input, _a[this.displayBy] = input, _a);
        // emit output
        this.model = model;
...
var defaults$1 = core.forwardRef(function () { return OptionsProvider.defaults.tagInput; });
...
exports.ɵd = TagInputDropdown;
exports.ɵi = DeleteIconComponent;
exports.ɵe = TagInputForm;
exports.ɵc = animations$1;
exports.ɵa = TagInputComponent;
exports.ɵg = TagRipple;
exports.ɵf = TagComponent;
exports.ɵb = TagInputAccessor;
exports.ɵj = HighlightPipe;
exports.ɵh = DragProvider;
